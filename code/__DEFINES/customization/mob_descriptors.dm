...
#define MOB_DESCRIPTOR_SLOT_BUTT 12
#define MOB_DESCRIPTOR_SLOT_BELLY 13
#define MOB_DESCRIPTOR_SLOT_BREASTS 14
#define MOB_DESCRIPTOR_SLOT_VAGINA 15
#define MOB_DESCRIPTOR_SLOT_HEIGHT 16
