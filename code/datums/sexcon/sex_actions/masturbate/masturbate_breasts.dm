...
/datum/sex_action/masturbate_breasts/on_perform(mob/living/user, mob/living/target)
...
/datum/sex_action/masturbate_breasts/is_finished(mob/living/user, mob/living/target)
