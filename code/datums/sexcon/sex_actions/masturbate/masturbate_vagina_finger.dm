...
/datum/sex_action/masturbate_vagina_finger/shows_on_menu(mob/living/user, mob/living/target)
...
/datum/sex_action/masturbate_vagina_finger/on_finish(mob/living/user, mob/living/target)
	..()
	user.visible_message(span_warning("[user] stops fingering."))

/datum/sex_action/masturbate_vagina_finger/is_finished(mob/living/user, mob/living/target)
