...
/datum/status_effect/shadow_mend/on_remove()
	owner.visible_message("<span class='warning'>The violet light around [owner] glows black!</span>", "<span class='warning'>New godsdrils around you cinch tightly and reap their toll...</span>")
	playsound(owner, 'sound/blank.ogg', 50, TRUE)
