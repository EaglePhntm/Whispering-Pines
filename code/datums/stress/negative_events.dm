...
/datum/stressevent/eora_matchmaking
	stressadd = 2
	desc = span_rose("Moonbeam calls for me to be wed! I must find my destined partner before I die all alone...")
	timer = 30 MINUTES
