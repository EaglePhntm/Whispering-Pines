...
/obj/structure/wonder/proc/mark_victim(mob/living/carbon/human/V)
	...
	if(H && !QDELETED(dream_master))
		...
		//	V.add_client_colour(/datum/client_colour/maniac_marked) //Hurt peoples's eyes, we instead give them tenebrase's curse which make them experience the maniac's hallucinations, how cool.
