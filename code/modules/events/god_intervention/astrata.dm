...
/datum/round_event/astrata_grandeur/start()
	for(var/mob/living/carbon/human/human_mob in GLOB.player_list)
		...
		to_chat(human_mob, span_notice("Astrata shines brightly todae - and just as she leads new gods, so must you guide others with a firm hand. The Sun Queen demands no less from those who bask in her glory."))
