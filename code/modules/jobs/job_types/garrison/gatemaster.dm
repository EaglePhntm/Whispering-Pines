/datum/job/gatemaster
	...
	On top of that... You get the benefit of taking advantage of who's before you, any way you like, \
	as long as you make sure it's not one of the Lord's guests or else."
	flag = GATEMASTER
...
/datum/advclass/gatemaster/gatemaster_bow
	...
	There is yet to be an arrow fired from you, that did not put the fear of their god into their eyes."
