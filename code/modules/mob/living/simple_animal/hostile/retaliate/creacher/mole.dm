...
/mob/living/simple_animal/hostile/retaliate/mole/briars
	...
	desc = "One of many miracles of Blissrose, they hide in deep forests only able to be summoned by wise briars who dedicate themselves to call for spirits of forest in time of need"
	icon = 'icons/roguetown/mob/monster/mole.dmi'
